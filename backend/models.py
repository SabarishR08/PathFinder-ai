...
class RiskScoreRequest(BaseModel):
    ...
    region: str = Field(..., description="Learner's region")
    highest_education: str = Field(..., description="e.g. HE Qualification, A Level")
    imd_band: str = Field(..., description="IMD band, e.g. 50-60%")
    age_band: str = Field(..., description="e.g. 0-35, 35-55")
    disability: str = Field("N", description="Y or N")
