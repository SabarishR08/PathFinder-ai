...
code = code.replace(
  /const openaiProvider = createOpenAI\(\{\s*apiKey: process\.env\.GROQ_API_KEY \|\| process\.env\.OPENAI_API_KEY,\s*baseURL: process\.env\.GROQ_BASE_URL \|\| "https:\/\/api\.groq\.com\/openai\/v1",\s*\}\);/,
